...
public class LoginSiswaActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (isLoggedIn) {
            startActivity(new Intent(LoginSiswaActivity.this, SiswaHomeActivity.class));
            finish();
            return;
        }
                                    ...
                                    .addOnSuccessListener(documentSnapshot -> {
                                        if (documentSnapshot.exists()) {
                                            ...
                                            if (role != null && role.equals("siswa")) {
                                                ...
                                                Toast.makeText(LoginSiswaActivity.this, "Akun ini bukan untuk siswa!", Toast.LENGTH_SHORT).show();
                                            }
                                        } else {
                                            Toast.makeText(LoginSiswaActivity.this, "Data pengguna tidak ditemukan di Firestore", Toast.LENGTH_SHORT).show();
                                        }
                                    })
                                    .addOnFailureListener(e -> {
                                        Toast.makeText(LoginSiswaActivity.this, "Gagal mengambil data pengguna: " + e.getMessage(), Toast.LENGTH_SHORT).show();
                                    });
                        } else {
        ...
        btnDaftar.setOnClickListener(v -> {
            startActivity(new Intent(LoginSiswaActivity.this, SignUpActivity.class));
        });

        txtLupaPassword.setOnClickListener(v -> {
            startActivity(new Intent(LoginSiswaActivity.this, LupaPasswordActivity.class));
        });
